...
#
# Generated by export_simulation on Tue Sep 20 17:45:57 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_i2.sh' script.

./bd_ram_i2.sh -reset_run
...
./bd_ram_i2.sh -noclean_files

For more information on the script, please type './bd_ram_i2.sh -help'.
