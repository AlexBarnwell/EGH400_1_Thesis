...
#
# Generated by export_simulation on Tue Sep 20 17:46:33 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_r1.sh' script.

./bd_ram_r1.sh -reset_run
...
./bd_ram_r1.sh -noclean_files

For more information on the script, please type './bd_ram_r1.sh -help'.
