...
#
# Generated by export_simulation on Tue Sep 20 17:45:54 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_i3.sh' script.

./bd_ram_i3.sh -reset_run
...
./bd_ram_i3.sh -noclean_files

For more information on the script, please type './bd_ram_i3.sh -help'.
