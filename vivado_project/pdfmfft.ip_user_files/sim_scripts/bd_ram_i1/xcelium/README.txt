...
#
# Generated by export_simulation on Sun Sep 18 14:56:27 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_i1.sh' script.

./bd_ram_i1.sh -reset_run
...
./bd_ram_i1.sh -noclean_files

For more information on the script, please type './bd_ram_i1.sh -help'.
