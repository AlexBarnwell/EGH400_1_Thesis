...
#
# Generated by export_simulation on Thu Sep 22 16:34:16 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './dsp_macro_0.sh' script.

./dsp_macro_0.sh -reset_run
...
./dsp_macro_0.sh -noclean_files

For more information on the script, please type './dsp_macro_0.sh -help'.
