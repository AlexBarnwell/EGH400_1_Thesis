...
#
# Generated by export_simulation on Mon Oct 03 13:13:30 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_i5.sh' script.

./bd_ram_i5.sh -reset_run
...
./bd_ram_i5.sh -noclean_files

For more information on the script, please type './bd_ram_i5.sh -help'.
