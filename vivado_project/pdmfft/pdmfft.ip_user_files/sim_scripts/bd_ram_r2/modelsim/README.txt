...
#
# Generated by export_simulation on Sat Oct 08 12:48:53 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_r2.sh' script.

./bd_ram_r2.sh -reset_run
...
./bd_ram_r2.sh -noclean_files

For more information on the script, please type './bd_ram_r2.sh -help'.
