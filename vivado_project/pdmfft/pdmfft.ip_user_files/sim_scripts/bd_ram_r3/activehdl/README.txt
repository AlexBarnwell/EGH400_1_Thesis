...
#
# Generated by export_simulation on Wed Sep 28 13:26:44 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_r3.sh' script.

./bd_ram_r3.sh -reset_run
...
./bd_ram_r3.sh -noclean_files

For more information on the script, please type './bd_ram_r3.sh -help'.
