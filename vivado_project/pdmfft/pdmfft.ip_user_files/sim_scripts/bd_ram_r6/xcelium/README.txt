...
#
# Generated by export_simulation on Tue Oct 18 12:04:21 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_r6.sh' script.

./bd_ram_r6.sh -reset_run
...
./bd_ram_r6.sh -noclean_files

For more information on the script, please type './bd_ram_r6.sh -help'.
