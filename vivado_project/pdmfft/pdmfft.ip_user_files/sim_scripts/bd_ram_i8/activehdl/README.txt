...
#
# Generated by export_simulation on Tue Oct 18 12:04:02 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_i8.sh' script.

./bd_ram_i8.sh -reset_run
...
./bd_ram_i8.sh -noclean_files

For more information on the script, please type './bd_ram_i8.sh -help'.
