...
#
# Generated by export_simulation on Thu Sep 22 16:53:21 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './bd_ram_r4.sh' script.

./bd_ram_r4.sh -reset_run
...
./bd_ram_r4.sh -noclean_files

For more information on the script, please type './bd_ram_r4.sh -help'.
