...
HD_PWD='C:/REPOS/EGH400-1/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/tw_ram_sin_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log tw_ram_sin.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source tw_ram_sin.tcl
