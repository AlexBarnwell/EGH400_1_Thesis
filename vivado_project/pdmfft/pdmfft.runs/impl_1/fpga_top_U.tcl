...
OPTRACE "read constraints: implementation" START { }
  ...
  read_xdc C:/REPOS/EGH400-1/EGH400_1_Thesis/src/constraints/bitstream_flash_config.xdc
OPTRACE "read constraints: implementation" END { }
OPTRACE "add files" END { }
OPTRACE "link_design" START { }
  link_design -top fpga_top_U -part xc7a35ticsg324-1L 
...
OPTRACE "Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_top_U_opt.dcp
OPTRACE "Opt Design: write_checkpoint" END { }
OPTRACE "opt_design reports" START { REPORT }
  create_report "impl_1_opt_report_drc_0" "report_drc -file fpga_top_U_drc_opted.rpt -pb fpga_top_U_drc_opted.pb -rpx fpga_top_U_drc_opted.rpx"
...
OPTRACE "Place Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_top_U_placed.dcp
OPTRACE "Place Design: write_checkpoint" END { }
OPTRACE "place_design reports" START { REPORT }
  create_report "impl_1_place_report_io_0" "report_io -file fpga_top_U_io_placed.rpt"
  create_report "impl_1_place_report_utilization_0" "report_utilization -file fpga_top_U_utilization_placed.rpt -pb fpga_top_U_utilization_placed.pb"
  create_report "impl_1_place_report_control_sets_0" "report_control_sets -verbose -file fpga_top_U_control_sets_placed.rpt"
...
OPTRACE "Post-Place Phys Opt Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_top_U_physopt.dcp
...
OPTRACE "Route Design: write_checkpoint" START { CHECKPOINT }
  write_checkpoint -force fpga_top_U_routed.dcp
OPTRACE "Route Design: write_checkpoint" END { }
OPTRACE "route_design reports" START { REPORT }
  create_report "impl_1_route_report_drc_0" "report_drc -file fpga_top_U_drc_routed.rpt -pb fpga_top_U_drc_routed.pb -rpx fpga_top_U_drc_routed.rpx"
  create_report "impl_1_route_report_methodology_0" "report_methodology -file fpga_top_U_methodology_drc_routed.rpt -pb fpga_top_U_methodology_drc_routed.pb -rpx fpga_top_U_methodology_drc_routed.rpx"
  create_report "impl_1_route_report_power_0" "report_power -file fpga_top_U_power_routed.rpt -pb fpga_top_U_power_summary_routed.pb -rpx fpga_top_U_power_routed.rpx"
  create_report "impl_1_route_report_route_status_0" "report_route_status -file fpga_top_U_route_status.rpt -pb fpga_top_U_route_status.pb"
  create_report "impl_1_route_report_timing_summary_0" "report_timing_summary -max_paths 10 -report_unconstrained -file fpga_top_U_timing_summary_routed.rpt -pb fpga_top_U_timing_summary_routed.pb -rpx fpga_top_U_timing_summary_routed.rpx -warn_on_violation "
  create_report "impl_1_route_report_incremental_reuse_0" "report_incremental_reuse -file fpga_top_U_incremental_reuse_routed.rpt"
  create_report "impl_1_route_report_clock_utilization_0" "report_clock_utilization -file fpga_top_U_clock_utilization_routed.rpt"
  create_report "impl_1_route_report_bus_skew_0" "report_bus_skew -warn_on_violation -file fpga_top_U_bus_skew_routed.rpt -pb fpga_top_U_bus_skew_routed.pb -rpx fpga_top_U_bus_skew_routed.rpx"
...
OPTRACE "route_design write_checkpoint" END { }
  write_checkpoint -force fpga_top_U_routed_error.dcp
