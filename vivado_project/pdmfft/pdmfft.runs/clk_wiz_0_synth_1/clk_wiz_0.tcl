...
namespace eval ::optrace {
  variable script "C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/clk_wiz_0_synth_1/clk_wiz_0.tcl"
...
set cacheID [config_ip_cache -export -no_bom  -dir C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/clk_wiz_0_synth_1 -new_name clk_wiz_0 -ip [get_ips clk_wiz_0]]
...
if { [catch {
  file copy -force C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/clk_wiz_0_synth_1/clk_wiz_0.dcp c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0.dcp
} _RESULT ] } { 
...
if { [catch {
  write_verilog -force -mode synth_stub c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode synth_stub c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  write_verilog -force -mode funcsim c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  write_vhdl -force -mode funcsim c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
...
if { [catch {
  file rename -force C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.v c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_stub.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a Verilog synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/clk_wiz_0_synth_1/clk_wiz_0_stub.vhdl c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_stub.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create a VHDL synthesis stub for the sub-design. This may lead to errors in top level synthesis of the design. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.v c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_sim_netlist.v
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the Verilog functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}

if { [catch {
  file rename -force C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/clk_wiz_0_synth_1/clk_wiz_0_sim_netlist.vhdl c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_sim_netlist.vhdl
} _RESULT ] } { 
  puts "CRITICAL WARNING: Unable to successfully create the VHDL functional simulation sub-design file. Post-Synthesis Functional Simulation with this file may not be possible or may give incorrect results. Error reported: $_RESULT"
}
...
if {[file isdir C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_stub.v C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.ip_user_files/ip/clk_wiz_0
  }
}

if {[file isdir C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.ip_user_files/ip/clk_wiz_0]} {
  catch { 
    file copy -force c:/EGH400_1_Thesis/src/ip/clk_wiz_0/clk_wiz_0_stub.vhdl C:/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.ip_user_files/ip/clk_wiz_0
  }
}
