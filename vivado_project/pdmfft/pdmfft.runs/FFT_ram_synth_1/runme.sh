...
HD_PWD='C:/REPOS/EGH400-1/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/FFT_ram_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log FFT_ram.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source FFT_ram.tcl
