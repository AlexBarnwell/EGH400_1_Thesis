...
HD_PWD='C:/REPOS/EGH400-1/EGH400_1_Thesis/vivado_project/pdmfft/pdmfft.runs/bd_ram_r2_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log bd_ram_r2.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source bd_ram_r2.tcl
