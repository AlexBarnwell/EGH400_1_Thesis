...
#
# Generated by Vivado on Sat Sep 03 16:40:46 +1000 2022
...
compile()
{
  vlogan -work xpm $vlogan_opts -sverilog +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../Initial_Implementation_FFT.gen/sources_1/ip/clk_wiz_0" \
  ...
  vlogan -work xil_defaultlib $vlogan_opts +v2k +incdir+"$ref_dir/../../../ipstatic" +incdir+"$ref_dir/../../../../Initial_Implementation_FFT.gen/sources_1/ip/clk_wiz_0" \
    "$ref_dir/../../../../Initial_Implementation_FFT.gen/sources_1/ip/clk_wiz_0/clk_wiz_0_clk_wiz.v" \
    "$ref_dir/../../../../Initial_Implementation_FFT.gen/sources_1/ip/clk_wiz_0/clk_wiz_0.v" \
  2>&1 | tee -a vlogan.log
