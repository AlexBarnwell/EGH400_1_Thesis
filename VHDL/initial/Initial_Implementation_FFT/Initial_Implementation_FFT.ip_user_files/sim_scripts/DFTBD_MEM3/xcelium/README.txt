...
#
# Generated by export_simulation on Sun Jul 31 13:33:24 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM3.sh' script.

./DFTBD_MEM3.sh -reset_run
...
./DFTBD_MEM3.sh -noclean_files

For more information on the script, please type './DFTBD_MEM3.sh -help'.
