...
#
# Generated by export_simulation on Wed Sep 07 19:00:22 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM2.sh' script.

./DFTBD_MEM2.sh -reset_run
...
./DFTBD_MEM2.sh -noclean_files

For more information on the script, please type './DFTBD_MEM2.sh -help'.
