...
#
# Generated by export_simulation on Tue Aug 30 18:41:04 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM1.sh' script.

./DFTBD_MEM1.sh -reset_run
...
./DFTBD_MEM1.sh -noclean_files

For more information on the script, please type './DFTBD_MEM1.sh -help'.
