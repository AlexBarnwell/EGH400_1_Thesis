...
#
# Generated by export_simulation on Wed Aug 24 23:34:28 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM7.sh' script.

./DFTBD_MEM7.sh -reset_run
...
./DFTBD_MEM7.sh -noclean_files

For more information on the script, please type './DFTBD_MEM7.sh -help'.
