...
#
# Generated by export_simulation on Sun Jul 31 13:33:26 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM8.sh' script.

./DFTBD_MEM8.sh -reset_run
...
./DFTBD_MEM8.sh -noclean_files

For more information on the script, please type './DFTBD_MEM8.sh -help'.
