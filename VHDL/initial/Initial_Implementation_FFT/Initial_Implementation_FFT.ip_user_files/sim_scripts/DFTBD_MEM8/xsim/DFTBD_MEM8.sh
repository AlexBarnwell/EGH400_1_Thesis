...
#
# Generated by Vivado on Sun Sep 11 15:07:51 +1000 2022
...
elaborate()
{
  xelab --incr --debug typical --relax --mt auto -L blk_mem_gen_v8_4_5 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot DFTBD_MEM8 xil_defaultlib.DFTBD_MEM8 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim DFTBD_MEM8 -key {Behavioral:sim_1:Functional:DFTBD_MEM8} -tclbatch cmd.tcl -log simulate.log
}
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb DFTBD_MEM8.wdb xsim.dir)
