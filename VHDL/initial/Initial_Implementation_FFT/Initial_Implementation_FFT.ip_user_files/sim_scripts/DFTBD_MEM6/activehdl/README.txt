...
#
# Generated by export_simulation on Thu Aug 04 15:31:15 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM6.sh' script.

./DFTBD_MEM6.sh -reset_run
...
./DFTBD_MEM6.sh -noclean_files

For more information on the script, please type './DFTBD_MEM6.sh -help'.
