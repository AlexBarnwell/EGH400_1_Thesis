...
#
# Generated by export_simulation on Wed Aug 24 13:23:40 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM4.sh' script.

./DFTBD_MEM4.sh -reset_run
...
./DFTBD_MEM4.sh -noclean_files

For more information on the script, please type './DFTBD_MEM4.sh -help'.
