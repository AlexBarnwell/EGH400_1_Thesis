...
#
# Generated by export_simulation on Tue Aug 09 20:01:42 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './TW2_RAM.sh' script.

./TW2_RAM.sh -reset_run
...
./TW2_RAM.sh -noclean_files

For more information on the script, please type './TW2_RAM.sh -help'.
