...
HD_PWD='C:/REPOS/EGH400_1/EGH400_1_Thesis/VHDL/initial/Initial_Implementation_FFT/Initial_Implementation_FFT.runs/DFTDB_MEM6I_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFTDB_MEM6I.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFTDB_MEM6I.tcl
