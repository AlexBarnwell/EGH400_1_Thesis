...
HD_PWD='C:/REPOS/EGH400-1/EGH400_1_Thesis/VHDL/initial/Initial_Implementation_FFT/Initial_Implementation_FFT.runs/DFTB_MEM2I_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFTB_MEM2I.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFTB_MEM2I.tcl
