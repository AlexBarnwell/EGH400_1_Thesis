...
HD_PWD='C:/REPOS/EGH400_1/EGH400_1_Thesis/VHDL/initial/Initial_Implementation_FFT/Initial_Implementation_FFT.runs/DFTBD_MEM4_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFTBD_MEM4.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFTBD_MEM4.tcl
