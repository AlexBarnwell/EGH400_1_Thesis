...
HD_PWD='C:/REPOS/EGH400-1/EGH400_1_Thesis/VHDL/initial/Initial_Implementation_FFT/Initial_Implementation_FFT.runs/TW2_RAM_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TW2_RAM.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TW2_RAM.tcl
