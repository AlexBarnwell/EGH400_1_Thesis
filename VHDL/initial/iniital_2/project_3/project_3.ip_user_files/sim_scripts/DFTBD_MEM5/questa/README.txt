...
#
# Generated by export_simulation on Fri May 27 17:27:50 +1000 2022
#
################################################################################
...
'-reset_run' switch to the './DFTBD_MEM5.sh' script.

./DFTBD_MEM5.sh -reset_run
...
./DFTBD_MEM5.sh -noclean_files

For more information on the script, please type './DFTBD_MEM5.sh -help'.
