...
HD_PWD='C:/REPOS/EGH400_1/VHDL/inital/initial_implemenation/initial_implemenation.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DFT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DFT.tcl
